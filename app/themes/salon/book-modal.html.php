    ...
    <form method="post" novalidate>
      ...
      <main>
        ...
        <div class="row" style="gap:1rem;margin-top:1rem">
          ...
          <div class="col" style="flex:1">
            <p class="field required" data-control="#vanilla-calendar-1" data-type="Calendar">
              <label>Date</label>
              <input class="input" name="date" type="text" value="" 
                placeholder="- Use calendar to select -" 
                style="width:100%" autocomplete="off">
            </p>
            <div class="field required" data-type="Time">
              <label>Time</label>
            ...
            <p class="field required" data-type="Duration">
              ...
              <span class="range-input">
                <input name="duration" type="range" value="90" min="15" max="120" step="15" list="dur">
